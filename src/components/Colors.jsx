...
function Colors() {
  ...
  return (
    <section id="cores" className="bg-black p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid gap-8 mt-20 grid-cols-2">
          {models.map((model, index) => (
            <div
              key={index}
              className="bg-linear-to-br from-gray-900 to-transparent rounded-3xl p-8 border-gray-800"
            >
        ...
        <div className="text-center mt-16">
          <button className="bg-blue-700 hover:bg-blue-800 text=white px-12 py-4 rounded-full text-lg font-medium transition-all durantion-300 mb-8 hover:scale-105 shadow-md shadow-blue-500/50 cursor-pointer">
